 ...
 * @brief Namespace containing all configuration constants for the Order module
 * 
...
namespace OrderConfig {
        /**
     * @namespace OrderItem
     * @brief Configuration constants for OrderItem class
     */
    namespace OrderItem {
     ...
     * @brief Configuration constants for ShippingInfo class
     */
    namespace ShippingInfo {
     ...
     * @brief Configuration constants for CustomerOrder class
     */
    namespace CustomerOrder {
     ...
     * @brief Configuration constants for OrderManager class
     */
    namespace OrderManager {
    ...
    /**
     * @namespace Order
     * @brief Configuration constants for Order class
     */
    namespace Order {
     ...
     * @brief Configuration constants for PurchaseOrder class
     */
    namespace PurchaseOrder {
