...
namespace BookConfig {
    ...
    namespace BookSeries {
        ...
        static constexpr size_t YEAR_MAX = 2025;                  ///< YEAR max
        static constexpr size_t YEAR_MIN = 1400;                  ///< YEAR min
    }
    ...
    namespace Publisher {
        ...
        static constexpr size_t YEAR_MAX = 2025;                  ///< Current max year for validation
        static constexpr size_t YEAR_MIN = 1400;                  ///< Current min year for validation
    }
